      ...
      <div class="auth-card">
        ...
        <form action="{{ url('/login') }}" method="POST" autocomplete="off">
          ...
          <div class="form-meta">
            ...
            <a href="javascript:alert('Silakan hubungi administrator perpustakaan untuk bantuan reset password.')" class="forgot-link">Lupa Password?</a>
          </div>
          ...
          <a href="javascript:alert('Fitur Google Login Siap Digunakan')" class="btn-google">
